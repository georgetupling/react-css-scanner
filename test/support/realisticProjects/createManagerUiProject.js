  ...
  return new TestProjectBuilder()
    ...
    .withFile(
      ...
      [
        ...
        '    <script src="./shell/index.tsx"></script>',
        "  </body>",
        "</html>",
        "",
      ].join("\n"),
    ...
    .withSourceFile(
      ...
      [
        ...
        "  const frameClass = 'preview-frame preview-frame--device';",
        "  return (",
        '    <section className="preview-shell preview-shell--empty">',
        '      <header className="preview-shell__toolbar">Preview</header>',
        "      <article className={frameClass}>",
        '        <div className="preview-frame__chrome" />',
        '        <iframe className="preview-frame__content" title="active preview" />',
        "      </article>",
        "    </section>",
        "  );",
        "}",
    ...
    .withFile(
      ...
      [
        "module.exports = {",
        "  entry: { manager: './src/shell/index.tsx' },",
        "  module: {",
        "    rules: [",
