    ...
    analysisEvidence: {
      ...
      projectEvidence: {
        ...
        indexes: {
          ...
          cssDeclarationIdsByStylesheetId: new Map(),
          cssDeclarationIdsByRuleDefinitionNodeId: new Map(),
          cssDeclarationIdsBySelectorBranchId: new Map(),
          cssDeclarationIdsByProperty: new Map(),
