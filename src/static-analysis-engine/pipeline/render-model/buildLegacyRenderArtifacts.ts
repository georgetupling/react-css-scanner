...
export type LegacyRenderArtifactsBuildInput = {
  parsedFiles: Array<{
    filePath: string;
...
export type LegacyRenderArtifacts = {
...
export function buildLegacyRenderArtifacts(
  input: LegacyRenderArtifactsBuildInput,
): LegacyRenderArtifacts {
